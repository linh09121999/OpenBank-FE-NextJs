...
export interface ResPermissionToASystemView {
    entitlement_id: string;
    role_name: string;
    bank_id: string;
}

export interface ResSystemView {
    id: string;
    short_name: string;
    description: string;
    ...
    // New array fields for view access control
    can_grant_access_to_views: string[];
    can_revoke_access_to_views: string[];

    // Action permissions (all boolean flags)
...
export interface ResIdsOfSystemViews{
    views: ID[]
}