...
export const CreateMyApiCollection = (): Promise<AxiosResponse> => {
    return api.post(`/obp/v6.0.0/my/api-collections`)
}

export const CreateMyApiCollectionEndpoint = (api_collection_name: string): Promise<AxiosResponse> => {
    return api.post(`/obp/v6.0.0/my/api-collections/${api_collection_name}/api-collection-endpoints`)
}

export const CreateMyApiCollectionEndpointById = (api_collection_name: string): Promise<AxiosResponse> => {
    return api.post(`/obp/v6.0.0/my/api-collection-ids/${api_collection_name}/api-collection-endpoints`)
}

export const DeleteMyApiCollection = (api_collection_name: string): Promise<AxiosResponse> => {
    return api.delete(`/obp/v6.0.0/my/api-collections/${api_collection_name}`)
}

export const DeleteMyApiCollectionEndpoint = (api_collection_name: string, operation_id: string): Promise<AxiosResponse> => {
    return api.delete(`/obp/v6.0.0/my/api-collections/${api_collection_name}/api-collection-endpoints/${operation_id}`)
}

export const DeleteMyApiCollectionEndpointById = (api_collection_id: string, api_collection_endpoint_id: string): Promise<AxiosResponse> => {
...
export const GetApiCollectionEndpoints = (api_collection_id: string): Promise<AxiosResponse> => {
...
export const GetFeaturedApiCollections = (): Promise<AxiosResponse> => {
    return api.get(`/obp/v6.0.0/api-collections/featured`)
}

export const GetMyApiCollectionById = (api_collection_id: string): Promise<AxiosResponse> => {
    return api.get(`/obp/v6.0.0/my/api-collections/${api_collection_id}`)
}

export const GetMyApiCollectionByName = (api_collection_name: string): Promise<AxiosResponse> => {
    return api.get(`/obp/v6.0.0/my/api-collections/name/${api_collection_name}`)
}

export const GetMyApiCollectionEndpoint = (api_collection_name: string, operation_id: string): Promise<AxiosResponse> => {
    return api.get(`/obp/v6.0.0/my/api-collections/${api_collection_name}/api-collection-endpoints/${operation_id}`)
}

export const GetMyApiCollectionEndpoints = (api_collection_name: string): Promise<AxiosResponse> => {
    return api.get(`/obp/v6.0.0/my/api-collections/${api_collection_name}/api-collection-endpoints`)
}

export const GetMyApiCollectionEndpointsById = (api_collection_name: string): Promise<AxiosResponse> => {
    return api.get(`/obp/v6.0.0/my/api-collection-ids/${api_collection_name}/api-collection-endpoints`)
}

export const GetMyApiCollections = (): Promise<AxiosResponse> => {
    return api.get(`/obp/v6.0.0/my/api-collections`)
}

export const GetSharableApiCollectionById = (api_collection_id: string): Promise<AxiosResponse> => {
    return api.get(`/obp/v6.0.0/api-collections/sharable/${api_collection_id}`)
}

export const UpdateMyApiCollectionByAPI_COLLECTION_ID = (api_collection_id: string): Promise<AxiosResponse> => {
