...
export const AnswerTransactionRequestChallenge = (bank_id: string, account_id: string, view_id: string, transaction_request_type: string, transaction_request_id: string): Promise<AxiosResponse> => {
...
export const CreateTransactionRequest_ACCOUNT = (bank_id: string, account_id: string, view_id: string, account: string): Promise<AxiosResponse> => {
...
export const CreateTransactionRequest_ACCOUNT_OTP = (bank_id: string, account_id: string, view_id: string, account_otp: string): Promise<AxiosResponse> => {
...
export const CreateTransactionRequest_AGENT_CASH_WITHDRAWAL = (bank_id: string, account_id: string, view_id: string, agent_cash_withdrawal: string): Promise<AxiosResponse> => {
...
export const CreateTransactionRequest_CARD = (card: string): Promise<AxiosResponse> => {
    return api.post(`/obp/v4.0.0/transaction-request-types/${card}/transaction-requests`)
}

export const CreateTransactionRequest_COUNTERPARTY = (bank_id: string, account_id: string, view_id: string, counterparty: string): Promise<AxiosResponse> => {
...
export const CreateTransactionRequest_REFUND = (bank_id: string, account_id: string, view_id: string, refund: string): Promise<AxiosResponse> => {
...
export const CreateTransactionRequest_SANDBOX_TAN = (bank_id: string, account_id: string, view_id: string, sandbox_tan: string): Promise<AxiosResponse> => {
...
export const CreateTransactionRequest_SEPA = (bank_id: string, account_id: string, view_id: string, sepa: string): Promise<AxiosResponse> => {
    return api.post(`/obp/v4.0.0/banks/${bank_id}/accounts/${account_id}/${view_id}/transaction-request-types/${sepa}/transaction-requests`)
}

export const CreateTransactionRequest_SIMPLE = (bank_id: string, account_id: string, view_id: string, simple: string): Promise<AxiosResponse> => {
...
export const GetTransactionRequest = (bank_id: string, account_id: string, view_id: string, transaction_request_id: string): Promise<AxiosResponse> => {
...
export const GetTransactionRequestTypesAtBank = (bank_id: string): Promise<AxiosResponse> => {
    return api.get(`/obp/v4.0.0/banks/${bank_id}/transaction-request-types`)
}

export const GetTransactionRequestTypesForAccount = (bank_id: string, account_id: string, view_id: string): Promise<AxiosResponse> => {
...
export const GetTransactionRequests = (bank_id: string, account_id: string, view_id: string): Promise<AxiosResponse> => {
