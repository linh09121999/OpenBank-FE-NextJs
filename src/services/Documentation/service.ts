...
export const GetGlossaryOfTheAPI = () => {
    return api.get(`/obp/v4.0.0/api/glossary`)
}

export const GetMessageDocs = (connector: string) => {
    return api.get(`/obp/v4.0.0/message-docs/${connector}`)
}

export const GetMessageDocsSwagger = (connector: string) => {
...
export const GetSwaggerdocumentation = (api_version: string) => {
    return api.get(`/obp/v4.0.0/resource-docs/${api_version}/swagger`)
}

export const GetScannedAPIVersions = () => {
