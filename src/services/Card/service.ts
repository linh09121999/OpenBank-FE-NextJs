...
export const CreateCardAttribute = (bank_id: string, card_id: string) => {
...
export const GetCardsForTheSpecifiedBank = (bank_id: string) => {
    return api.get(`/obp/v6.0.0/management/banks/${bank_id}/cards`)
}

export const GetCardsForTheCurrentUser = () => {
    return api.get(`/obp/v6.0.0/cards`)
}

export const GetStatusOfCreditCardOrder = (bank_id: string, account_id: string, view_id: string) => {
...
export const UpdateCardAttribute = (bank_id: string, card_id: string, card_attribute_id: string) => {
