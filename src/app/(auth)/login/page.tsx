...
const Login: React.FC = () => {
    ...
    return (
        <>
            <img src="/Frame-70-1.png" alt="bg" className="fixed top-0 left-0 w-full h-screen object-cover -z-10" />

            <div className="grid grid-cols-2">
                <div></div>
                <div className='flex flex-col gap-8 justify-center items-center w-full mx-auto max-w-[540px] p-5'>
