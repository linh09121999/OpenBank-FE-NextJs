...
const TransactionsPage: React.FC = () => {
    ...
    return (
        <>
            {resTransactionAccountCore.length > 0
            ...
            ${isDark
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div>
                        <p className="text-center text-gray-500 text-md">There are no transaction</p>
                        <p className="text-center text-gray-500 text-sm">You will need to create a new transaction.</p>
                    </div>
                    <Button onToggle={() => { }} padding="py-2 px-3" radius="rounded-xl" display="flex gap-1 items-center" fontSize="text-md"><MdAdd /> Add transaction</Button>
                </div>
            }
        </>
    )
