  ...
  return (
    <>
      <div className={`grid  gap-5 ${resCustomerForCurrentUser.length > 0 ? "md:grid-cols-4" : "md:grid-cols-3"}`}>
              ...
              <g className="apexcharts-inner apexcharts-graphical" transform="translate(0, 0)">
                <defs>
                  ...
                  <linearGradient id="lineGradient" x1="0" y1="1" x2="1" y2="1">
                    <stop stopOpacity="1" stopColor="rgba(228,59,255,1)" offset="0" />
                    <stop stopOpacity="1" stopColor="rgba(228,59,255,1)" offset="1" />
                  </linearGradient>
                </defs>
        ...
        <div className={`md:col-span-2 md:col-start-1 md:row-start-2 p-5 rounded-3xl shadow-lg backdrop-blur-xl flex justify-between gap-5
            ${isDark
